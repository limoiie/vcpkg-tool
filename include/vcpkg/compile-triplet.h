...
namespace vcpkg::bin2sth
{
    ...
    public:
        ...
        static Optional<CompileTriplet> from_canonical_name(std::string const& canonical_name);
    ...
    Optional<bin2sth::CompileTriplet> default_compile_triplet(VcpkgCmdArguments const& args);
